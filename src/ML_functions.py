def resample_data(
    X_train, y_train, feature_names, class_label, resample_method=None, seed=1
):
    ...
    print(
        "Shape of X_train, shape of df_train features, length of y_train: ",
        X_train.shape,
        df_train.shape,
        len(y_train),
    )
...
def plot_vary_hyper_param(
    X_train, y_train, X_test, y_test, ml_model, param_list, param_name
):
