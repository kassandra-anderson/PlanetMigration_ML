...
feature_names = ["log_eps_gr_input",
                 "log_eps_tide1_input",
                 "log_eps_tide2_input",
                 "log_eps_rot1_input",
                 "log_eps_rot2_input",
...
for name, model in models_dict.items():
    ...
    # Pickle the pipeline
    outfile = outpath + name + "_" + scaler_name + "_" + resampler_name + \
